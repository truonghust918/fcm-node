    ...
    this.send = function(payload, CB) {
        ...
        operation.attempt(function(currentAttempt) {
            var headers = {
                ...
                //'Content-Length': mpayload.length //removed this like for chunked-encoding transfer compatibility (UTF-8)
            };
            ...
            var request = https.request(self.fcmOptions, function(res) {
                ...
                function respond() {
                    ...
                    } else if(data.indexOf('\"message_id\":')>-1){  //topic messages //FIXME: handle UTF-8 messages
                        id=data;
                    }else {
